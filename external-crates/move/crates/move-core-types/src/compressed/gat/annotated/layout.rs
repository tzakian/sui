...
use crate::compressed::gat::VariantTag;
use crate::compressed::gat::backend::DefaultAnnotated;
use crate::compressed::gat::backend::annotated_nodes::{AnnotatedFieldEntry, AnnotatedVariantEntry};
...
pub use crate::compressed::gat::backend::DefaultAnnotatedBuilder as MoveTypeLayoutBuilder;
...
/// [`crate::compressed::gat::runtime::BackendBuilder`] but with annotated-specific
