...
Returns the original package id for the given <code>package_id</code> that must be <code><a href="../sui/package.md#sui_package_version">version</a></code> of the package.
If <code>package_id</code>'s version is not <code><a href="../sui/package.md#sui_package_version">version</a></code>, <code><a href="../sui/package.md#sui_package_EInvalidPackageVersion">EInvalidPackageVersion</a></code> will be raised.
