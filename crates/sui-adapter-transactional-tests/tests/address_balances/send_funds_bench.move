...
//# bench-programmable --sender A --address-balance-gas --inputs withdraw<sui::balance::Balance<sui::sui::SUI>>(100) @B
...
// with gas paid from the address balance.
//# bench-programmable --sender A --address-balance-gas --inputs withdraw<sui::balance::Balance<sui::sui::SUI>>(100) withdraw<sui::balance::Balance<sui::sui::SUI>>(100) withdraw<sui::balance::Balance<sui::sui::SUI>>(100) withdraw<sui::balance::Balance<sui::sui::SUI>>(100) @B @C @D @E
//> 0: sui::balance::redeem_funds<sui::sui::SUI>(Input(0));
